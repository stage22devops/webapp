package com.faouzi.webapp.controller;
...
import com.faouzi.webapp.service.EmployeeService;
...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@ModelAttribute Employee employee) {
		if(employee.getId() != null) {
			...
			Employee current = service.getEmployee(Integer.parseInt(employee.getId()));
